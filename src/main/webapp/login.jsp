			...
			<form action="./LoginSrv" method="post"
				...
				<div class="row">
					<div class="col-md-12 form-group">
						<label for="user_name"></label> <input type="email"
							placeholder="Tên đăng nhập" name="username" class="form-control input-lg"
				...
				<div class="row">
					<div class="col-md-12 form-group">
						...
						<input type="password"
							placeholder="Mật khẩu" name="password" class="form-control input-lg"
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<button type="submit" class="btn btn-primary btn-lg btn-block input-lg"
								style="background-color: #ee4d2d; border: none; border-radius: 0;">Đăng Nhập
						</button>
					</div>
				</div>
			</form>

	...
	<div class="container">
		<div class="row"
			...
			<form action="./AddProductSrv" method="post"
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Tiền Tệ</label> <input type="number"
							placeholder="Nhập Tiền Tệ" name="price" class="form-control"
							id="last_name" required>
					</div>
					<div class="col-md-6 form-group">
						<label for="last_name">Số Lượng Sản Phẩm</label> <input type="number"
							placeholder="Nhập Số Lượng Sản Phẩm" name="quantity"
